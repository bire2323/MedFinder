          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <aside className="md:col-span-4 lg:col-span-5 order-2 lg:order-1 space-y-4">
              <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800/40 p-4 shadow-sm">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  {facilitiesLoading ? (
                    ...
                    <div className="space-y-2 max-h-[380px] md:max-h-[420px] overflow-y-auto pr-1">
              ...
              <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800/40 p-4 shadow-sm">
                ...
                <div className="mt-4 space-y-2 max-h-[260px] md:max-h-[320px] overflow-y-auto pr-1">
              ...
              <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800/40 p-4 shadow-sm">
                ...
                <div className="mt-4">
                  {isUploading || isProcessingPrescription ? (
                    ...
                    <div className="space-y-3 max-h-[340px] md:max-h-[420px] overflow-y-auto pr-1">
