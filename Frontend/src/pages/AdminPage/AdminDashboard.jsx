                ...
                {({ isActive }) => (
                  <>
                    ...
                    <span className={`relative z-10 flex items-center gap-2 transition-colors duration-300 ${
                      ...
                      {tab.label}
                      {tab.badge > 0 && (
                        <span className={`ml-0.5 rounded-full px-1.5 py-0.5 text-[9px] font-black leading-none ${
                          isActive 
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <NavLink
                    ...
                    className={({ isActive }) => `flex items-center gap-2.5 rounded-xl px-4.5 py-3 text-xs font-black uppercase tracking-wider transition-all border ${
                      isActive
