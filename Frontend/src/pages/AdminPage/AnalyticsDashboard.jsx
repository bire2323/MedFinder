  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex flex-row items-center justify-between pb-2">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Active Hospitals</h3>
          ...
          <p className="text-xs text-green-600 dark:text-green-400 mt-1">
            <TrendingUp className="size-3 inline mr-1" />
            +{overview.hospitalGrowth}% from last period
          </p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex flex-row items-center justify-between pb-2">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Active Pharmacies</h3>
          ...
          <p className="text-xs text-green-600 dark:text-green-400 mt-1">
            <TrendingUp className="size-3 inline mr-1" />
            +{overview.pharmacyGrowth}% from last period
          </p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex flex-row items-center justify-between pb-2">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Chats (24h)</h3>
          ...
          <p className="text-xs text-green-600 dark:text-green-400 mt-1">
            <TrendingUp className="size-3 inline mr-1" />
            +{overview.chatGrowth}% from last period
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="px-6 pt-6">
          <h3 className="font-semibold">User Activity Trends</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Daily active users by role</p>
        </div>
        <div className="p-6 pt-2 h-80">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={sampleUserActivity}>
              ...
              <Line type="monotone" dataKey="hospitalAgents" stroke="#8b5cf6" strokeWidth={2} name="Hospital Agents" />
              <Line type="monotone" dataKey="pharmacyAgents" stroke="#10b981" strokeWidth={2} name="Pharmacy Agents" />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="px-6 pt-6">
            <h3 className="font-semibold">Chatbot Interactions</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Usage by hour (sample)</p>
          </div>
          <div className="p-6 pt-2 h-80">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="px-6 pt-6">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Most requested (sample)</p>
          </div>
          <div className="p-6 pt-2 h-80">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          <h3 className="font-semibold text-lg mb-2">Peak Activity Time</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          <h3 className="font-semibold text-lg mb-2">User Satisfaction</h3>
          <div className="flex items-center gap-3">
