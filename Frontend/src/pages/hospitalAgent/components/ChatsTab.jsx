  ...
  return (
    ...
    >
      <div className="flex h-full relative">
        {/* Chat list */}
        <div 
          className={`w-full lg:w-[380px] border-r border-slate-100 dark:border-gray-700 flex flex-col bg-slate-50/50 dark:bg-gray-900/20 transition-all duration-300 ${
            ...
            {loadingChats ? (
              ...
              filteredSessions.map((session) => (
                <button
                  ...
                  className={`w-full group p-4 rounded-3xl text-left transition-all duration-300 relative ${
                ...
                >
                   ...
                   <div className="flex items-center gap-4">
                      <div className="relative shrink-0">
                         <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black text-lg transition-transform duration-300 group-hover:scale-105 shadow-sm ${
                           selectedSessionId === session.id 
        ...
        <div className={`flex-1 flex flex-col bg-white dark:bg-gray-900/20 h-full overflow-hidden transition-all duration-500 ${
          !selectedSessionId ? "hidden lg:flex" : "flex"
        }`}>
          {selectedSessionId ? (
