          ...
          <div className="px-10 pb-10 space-y-6">
            ...
            {!isDept && (
              <div className="grid grid-cols-1 gap-6">
                <div className="flex items-center gap-4 p-5 bg-slate-50 dark:bg-gray-900 rounded-3xl border-2 border-transparent">
                  <input
                    type="checkbox"
                    id="is_available"
                    onKeyDown={handleKeyDown}
                  ...
                  />
                  <label htmlFor="is_available" className="font-bold text-slate-700 dark:text-slate-300">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-6 py-4 bg-slate-50 dark:bg-gray-900 border-2 border-transparent focus:border-blue-500 rounded-3xl outline-none transition-all font-bold min-h-[100px]"
            ...
            <div className="pt-6">
              <button
                ...
                className={`w-full py-5 rounded-[2rem] font-black text-white text-lg shadow-xl transition-all active:scale-95 flex items-center justify-center gap-3 ${isDept ? "bg-blue-600 shadow-blue-500/30 hover:bg-blue-700" : "bg-emerald-600 shadow-emerald-500/30 hover:bg-emerald-700"
                  } disabled:opacity-50`}
              >
