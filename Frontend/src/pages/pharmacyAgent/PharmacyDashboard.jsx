  ...
  return (
    <>
      ...
      <div className="min-h-screen min-w-[320px] bg-slate-50/50 dark:bg-slate-950 flex text-slate-900 dark:text-gray-100 transition-colors duration-300">
        ...
        <nav className={`fixed lg:sticky border-r border-slate-200/50 dark:border-slate-800/80 inset-y-0 lg:bottom-auto left-0 z-40 w-64 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl flex flex-col transform transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
