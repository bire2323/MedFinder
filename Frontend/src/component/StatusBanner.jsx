...
const StatusBanner = ({ status, rejectionReason }) => {
  ...
  return (
    <div className={`mb-6 p-4 rounded-xl border flex gap-4 items-start ${isPending
      && 'bg-amber-50 border-amber-200 text-amber-800 dark:bg-amber-900/20 dark:border-amber-900/40 dark:text-amber-400'
      }${isRejected && 'bg-red-50 border-red-200 text-red-800 dark:bg-red-900/20 dark:border-red-900/40 dark:text-red-400'
      }${isApproved && "hidden bg-green-50 border-green-200"}`}>
