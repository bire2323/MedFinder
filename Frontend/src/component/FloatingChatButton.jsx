                ...
                <div className="flex items-center gap-1.5">
                  {sessions.length > 0 && (
                    <button
                      ...
                      className="bg-rose-700 hover:bg-rose-600 px-2 py-1 rounded-xl font-bold text-[8px] flex items-center gap-1 transition-all cursor-pointer shadow-md active:scale-95 text-white"
                  ...
                  <button
                    onClick={handleNewSession}
                    className="bg-emerald-700 hover:bg-emerald-600 px-2 py-1 rounded-xl font-bold text-[8px] flex items-center gap-1.5 transition-all cursor-pointer shadow-md active:scale-95"
                  >
